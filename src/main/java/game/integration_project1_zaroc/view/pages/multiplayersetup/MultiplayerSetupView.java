...
public class MultiplayerSetupView extends BorderPane {
    ...
    private void initialiseNodes(){
        ...
        this.hostGame = new LongButtonComponent(resourceManager,"HOST GAME");
        this.joinGame= new LongButtonComponent(resourceManager,"JOIN GAME");
    }
    ...
    private void layoutNodes(){
        ...
        Label joinGameLabel = new Label("join with a code");

...
public class RuleView extends BorderPane {
    ...
    public void layoutNodes() {
        ...
        ruleBorderPane.setPadding(new Insets(40,110,30,110));


        StackPane ruleStackPane = new StackPane(ruleBorderPane, returnButton);

        StackPane.setAlignment(ruleBorderPane, Pos.CENTER);
        StackPane.setMargin(ruleBorderPane, new Insets(40,0,40,0));
        ...
        ruleStackPane.setBackground(new Background(backgroundImage));
